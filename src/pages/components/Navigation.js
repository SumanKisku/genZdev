...
export default function Navigation(props) {
  ...
  return (
      <nav className="m-6 md:flex md:flex-row md:justify-between">
          ...
          <ul id="menu" className="m-1 text-right transform translate-x-full transition-transform duration-500 md:transform md:translate-x-0 ease-in md:flex md:flex-row md:space-x-5">
